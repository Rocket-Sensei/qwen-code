...
export default {
  ...
  WITTY_LOADING_PHRASES: [
    ...
    // Mystic & dark phrases
    'Reading the entrails of a dead server...',
    'The void stares back... and it needs more RAM.',
    'Sacrificing a goat to the CI gods...',
    'Consulting the ancient runes of Stack Overflow...',
    'Peering into the abyss... it compiles.',
    'The spirits of deprecated APIs whisper the answer...',
    'Channeling the ghost of Turing...',
    'Bargaining with eldritch processes...',
    'The dark patterns are aligning...',
    'Feeding the void, one byte at a time...',
    'Whispering secrets to the daemon...',
    'The oracle requires a CAPTCHA...',
    'Dancing with shadows in the memory heap...',
    'Binding a rogue process to a pentacle...',
    'The graveyard of segfaults grows larger...',
    'Séance in progress... asking the dead threads...',
    'Summoning the kraken of recursion...',
    'The prophecy says: it works on my machine.',
    'Sacrificing a virgin try-catch block...',
    'The elder gods demand more test coverage...',
    'Consulting the Book of Infinite Loops...',
    'A demon was caught in the pipe... negotiating terms.',
    'The cryptid in the kernel demands an offering...',
    'Pouring salt on the race conditions...',
    'The necronomicon says: have you tried --force?',
  ],
